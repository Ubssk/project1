...
string[] StartArray = enter.Split(new char[] {' '}); // Разделение элементов строки в массив
int length = 3; // Параметр длины элемента первого массива
string[] WithoutQuotesArray = StartArray.Select(str => str.Replace("\"", "")).ToArray(); // Убираем кавычки из элементов массива
